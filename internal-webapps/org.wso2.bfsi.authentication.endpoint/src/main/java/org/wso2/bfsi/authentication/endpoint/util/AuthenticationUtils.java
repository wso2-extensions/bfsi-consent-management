...
import org.wso2.bfsi.authentication.endpoint.BFSIConsentConfirmServlet;
...
public class AuthenticationUtils {
     ...
     */
    public static BFSIAuthServletInterface getAuthExtension() {

        try {
            return (BFSIAuthServletInterface) Class.forName(parser.getAuthServletExtension())
