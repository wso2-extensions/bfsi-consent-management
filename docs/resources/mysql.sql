...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT (
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_AUTH_RESOURCE (
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_MAPPING (
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_STATUS_AUDIT (
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_FILE (
  CONSENT_ID        VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_ATTRIBUTE (
  CONSENT_ID        VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS BFSI_THROTTLE_DATA (
...
CREATE TABLE IF NOT EXISTS BFSI_CONSENT_HISTORY (
