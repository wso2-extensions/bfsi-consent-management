 ...
 */
@Component(
        name = "org.wso2.bfsi.consent.management.extensions.internal.ConsentExtensionsServiceComponent",
        immediate = true)
public class ConsentExtensionsServiceComponent {
    ...
    @Reference(
            service = org.wso2.bfsi.consent.management.service.ConsentCoreService.class,
            cardinality = ReferenceCardinality.MANDATORY,
            policy = ReferencePolicy.DYNAMIC,
