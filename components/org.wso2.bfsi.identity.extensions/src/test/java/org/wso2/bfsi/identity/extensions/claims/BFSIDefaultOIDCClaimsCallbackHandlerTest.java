 ...
 */
public class BFSIDefaultOIDCClaimsCallbackHandlerTest {

    @Spy
    private BFSIDefaultOIDCClaimsCallbackHandler obDefaultOIDCClaimsCallbackHandler;

    @BeforeClass
    public void beforeClass() throws IdentityApplicationManagementException {

        Map<String, Object> configMap = new HashMap<>();
        configMap.put(ConsentManagementConstants.CONSENT_ID_CLAIM_NAME, "consent_id");
        configMap.put(ConsentManagementConstants.REMOVE_TENANT_DOMAIN_FROM_SUBJECT, "true");
        configMap.put(ConsentManagementConstants.REMOVE_USER_STORE_DOMAIN_FROM_SUBJECT, "true");
        ...
        obDefaultOIDCClaimsCallbackHandler = Mockito.spy(BFSIDefaultOIDCClaimsCallbackHandler.class);
    }

    public static String getFilePath(String fileName) {

        if (StringUtils.isNotBlank(fileName)) {
            URL url = BFSIDefaultOIDCClaimsCallbackHandlerTest.class.getClassLoader().getResource(fileName);
            if (url != null) {
                try {
