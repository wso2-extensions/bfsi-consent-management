 ...
 */
public class BFSIDefaultOIDCClaimsCallbackHandler extends DefaultOIDCClaimsCallbackHandler {

    private static Log log = LogFactory.getLog(BFSIDefaultOIDCClaimsCallbackHandler.class);
