 ...
 */
public class BFSIDefaultClaimProvider extends BFSIClaimProvider {

    private static final Log log = LogFactory.getLog(BFSIDefaultClaimProvider.class);
    ...
    private JSONObject getRequestBodyFromCache(String[] cachedRequests) {
        ...
        try {
            if (cachedRequests.length > 0) {
                return CommonUtils.decodeRequestJWT(cachedRequests[0], "body");
            }
