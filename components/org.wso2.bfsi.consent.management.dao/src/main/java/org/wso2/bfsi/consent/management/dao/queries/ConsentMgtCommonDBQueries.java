...
package org.wso2.bfsi.consent.management.dao.queries;
...
public class ConsentMgtCommonDBQueries {
    ...
    public String getStoreConsentPreparedStatement() {
        ...
        return "INSERT INTO BFSI_CONSENT (CONSENT_ID, RECEIPT, CREATED_TIME, UPDATED_TIME, CLIENT_ID, CONSENT_TYPE, " +
    ...
    public String getGetConsentPreparedStatement() {
        ...
        return "SELECT * FROM BFSI_CONSENT WHERE CONSENT_ID = ?";
    }

    public String getGetConsentWithConsentAttributesPreparedStatement() {

        return "SELECT BFSI_CONSENT.CONSENT_ID, RECEIPT, CREATED_TIME, UPDATED_TIME, CLIENT_ID, CONSENT_TYPE, " +
                "CURRENT_STATUS, CONSENT_FREQUENCY, VALIDITY_TIME, RECURRING_INDICATOR, " +
                "BFSI_CONSENT_ATTRIBUTE.ATT_KEY, BFSI_CONSENT_ATTRIBUTE.ATT_VALUE FROM BFSI_CONSENT RIGHT JOIN " +
                "BFSI_CONSENT_ATTRIBUTE ON BFSI_CONSENT.CONSENT_ID = BFSI_CONSENT_ATTRIBUTE.CONSENT_ID WHERE " +
                "BFSI_CONSENT.CONSENT_ID = ?";
    }
    ...
    public String getGetDetailedConsentPreparedStatement() {
        ...
        return "SELECT obc.CONSENT_ID," +
                ...
                "cm.MAPPING_STATUS, " +
                "cm.PERMISSION " +
                "FROM BFSI_CONSENT obc " +
                "LEFT JOIN BFSI_CONSENT_ATTRIBUTE ca ON obc.CONSENT_ID=ca.CONSENT_ID " +
                "LEFT JOIN BFSI_CONSENT_AUTH_RESOURCE ocar ON obc.CONSENT_ID=ocar.CONSENT_ID " +
                "LEFT JOIN BFSI_CONSENT_MAPPING cm ON ocar.AUTH_ID=cm.AUTH_ID " +
                "WHERE obc.CONSENT_ID = ?";
    }

    public String getUpdateConsentStatusPreparedStatement() {

        return "UPDATE BFSI_CONSENT SET CURRENT_STATUS = ?, UPDATED_TIME = ? WHERE CONSENT_ID = ?";
    }

    public String getUpdateConsentReceiptPreparedStatement() {

        return "UPDATE BFSI_CONSENT SET RECEIPT = ? WHERE CONSENT_ID = ?";
    }

    public String getUpdateConsentValidityTimePreparedStatement() {

        return "UPDATE BFSI_CONSENT SET VALIDITY_TIME = ?, UPDATED_TIME = ? WHERE CONSENT_ID = ?";
    }

    public String getStoreAuthorizationPreparedStatement() {

        return "INSERT INTO BFSI_CONSENT_AUTH_RESOURCE (AUTH_ID, CONSENT_ID, AUTH_TYPE, USER_ID, AUTH_STATUS, " +
                "UPDATED_TIME) VALUES (?, ?, ?, ?, ?, ?)";
    }

    public String getGetAuthorizationResourcePreparedStatement() {

        return "SELECT * FROM BFSI_CONSENT_AUTH_RESOURCE WHERE AUTH_ID = ?";
    }

    public String getUpdateAuthorizationStatusPreparedStatement() {

        return "UPDATE BFSI_CONSENT_AUTH_RESOURCE SET AUTH_STATUS = ?, UPDATED_TIME = ? WHERE AUTH_ID = ?";
    }

    public String getUpdateAuthorizationUserPreparedStatement() {

        return "UPDATE BFSI_CONSENT_AUTH_RESOURCE SET USER_ID = ?, UPDATED_TIME = ? WHERE AUTH_ID = ?";
    }

    public String getStoreConsentMappingPreparedStatement() {

        return "INSERT INTO BFSI_CONSENT_MAPPING (MAPPING_ID, AUTH_ID, ACCOUNT_ID, PERMISSION, MAPPING_STATUS) " +
                "VALUES (?, ?, ?, ?, ?)";
    }

    public String getGetConsentMappingResourcesPreparedStatement() {

        return "SELECT * FROM BFSI_CONSENT_MAPPING WHERE AUTH_ID = ?";
    }

    public String getUpdateConsentMappingStatusPreparedStatement() {

        return "UPDATE BFSI_CONSENT_MAPPING SET MAPPING_STATUS = ? WHERE MAPPING_ID = ?";
    }

    public String getStoreConsentAttributesPreparedStatement() {

        return "INSERT INTO BFSI_CONSENT_ATTRIBUTE (CONSENT_ID, ATT_KEY, ATT_VALUE) VALUES (?, ?, ?)";
    }

    public String getGetConsentAttributesPreparedStatement() {

        return "SELECT * FROM BFSI_CONSENT_ATTRIBUTE WHERE CONSENT_ID = ?";
    }

    public String getGetConsentAttributesByNamePreparedStatement() {

        return "SELECT CONSENT_ID, ATT_VALUE FROM BFSI_CONSENT_ATTRIBUTE WHERE ATT_KEY = ?";
    }

    public String getConsentIdByConsentAttributeNameAndValuePreparedStatement() {

        return "SELECT CONSENT_ID FROM BFSI_CONSENT_ATTRIBUTE WHERE ATT_KEY = ? AND ATT_VALUE = ?";
    }

    public String getUpdateConsentAttributesPreparedStatement() {

        return "UPDATE BFSI_CONSENT_ATTRIBUTE SET ATT_VALUE = ? WHERE CONSENT_ID = ? and ATT_KEY = ?";
    }

    public String getDeleteConsentAttributePreparedStatement() {

        return "DELETE FROM BFSI_CONSENT_ATTRIBUTE WHERE CONSENT_ID = ? AND ATT_KEY = ?";
    }

    public String getStoreConsentFilePreparedStatement() {

        return "INSERT INTO BFSI_CONSENT_FILE (CONSENT_ID, CONSENT_FILE) VALUES (?, ?)";
    }

    public String getGetConsentFileResourcePreparedStatement() {
        return "SELECT * FROM BFSI_CONSENT_FILE WHERE CONSENT_ID = ?";
    }
    ...
    public String getSearchConsentsPreparedStatement(String whereClause, boolean shouldLimit, boolean shouldOffset,
        ...
        String selectClause = "(SELECT * FROM BFSI_CONSENT " + whereClause + ")";
        ...
        StringBuilder query = new StringBuilder("SELECT OBC.CONSENT_ID, " +
                ...
                "         FROM BFSI_CONSENT_AUTH_RESOURCE OCAR2 " +
                ...
                "           FROM BFSI_CONSENT_MAPPING OCM2 " +
                "           JOIN BFSI_CONSENT_AUTH_RESOURCE OCAR2 ON OCAR2.auth_id = OCM2.auth_id " +
                ...
                "AS OBC " +
                "LEFT JOIN BFSI_CONSENT_ATTRIBUTE CA ON OBC.CONSENT_ID=CA.CONSENT_ID " +
                joinType + "JOIN BFSI_CONSENT_AUTH_RESOURCE OCAR ON OBC.CONSENT_ID=OCAR.CONSENT_ID "
                + userIdFilterClause +
                "LEFT JOIN BFSI_CONSENT_MAPPING OCM ON OCAR.AUTH_ID=OCM.AUTH_ID WHERE " +
    ...
    public String getSearchAuthorizationResourcesPreparedStatement(String whereClause) {
        ...
        return "SELECT * FROM BFSI_CONSENT_AUTH_RESOURCE" + whereClause;
    }

    public String getStoreConsentStatusAuditRecordPreparedStatement() {

        return "INSERT INTO BFSI_CONSENT_STATUS_AUDIT (STATUS_AUDIT_ID, CONSENT_ID, CURRENT_STATUS, ACTION_TIME, " +
                "REASON, ACTION_BY, PREVIOUS_STATUS) VALUES (?, ?, ?, ?, ?, ?, ?)";
    }

    public String getGetConsentStatusAuditRecordsPreparedStatement() {

        return "SELECT * FROM BFSI_CONSENT_STATUS_AUDIT WHERE CONSENT_ID = COALESCE(?, CONSENT_ID) " +
    ...
    public String getConsentStatusAuditRecordsByConsentIdsPreparedStatement(String whereClause, boolean shouldLimit,
        ...
        StringBuilder query =
                new StringBuilder("SELECT * FROM BFSI_CONSENT_STATUS_AUDIT " + whereClause);
    ...
    public String getInsertConsentHistoryPreparedStatement() {
        ...
        return "INSERT INTO BFSI_CONSENT_HISTORY (TABLE_ID, RECORD_ID, HISTORY_ID, CHANGED_VALUES, " +
                "REASON, EFFECTIVE_TIMESTAMP) VALUES (?, ?, ?, ?, ?, ?)";
    }

    public String getGetConsentHistoryPreparedStatement(String whereClause) {

        return "SELECT * FROM BFSI_CONSENT_HISTORY " + whereClause + "ORDER BY EFFECTIVE_TIMESTAMP DESC";
    }

    public String getSearchExpiringConsentPreparedStatement(String statusesEligibleForExpirationCondition) {

        return "SELECT OBC.CONSENT_ID " +
                " FROM   BFSI_CONSENT_ATTRIBUTE CA " +
                " JOIN   BFSI_CONSENT OBC " +
