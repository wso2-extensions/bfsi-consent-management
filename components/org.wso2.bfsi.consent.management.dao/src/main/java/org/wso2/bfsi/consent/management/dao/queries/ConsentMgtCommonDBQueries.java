...
//     */
//    public String getDeleteConsentAttributeByConsentIdPreparedStatement() {
//
//        return "DELETE FROM OB_CONSENT_ATTRIBUTE WHERE CONSENT_ID = ?";
//    }
//
//    /**
...
//     */
//    public String getDeleteConsentFileResourcePreparedStatement() {
//
//        return "DELETE FROM OB_CONSENT_FILE WHERE CONSENT_ID = ?";
//    }
//
//    /**
...
//     */
//    public String getDeleteConsentMappingByAuthIdPreparedStatement() {
//
//        return "DELETE OBCM FROM OB_CONSENT_MAPPING OBCM INNER JOIN OB_CONSENT_AUTH_RESOURCE " +
//                "OBAR ON OBCM.AUTH_ID = OBAR.AUTH_ID WHERE OBAR.CONSENT_ID = ?";
//    }
//
//    /**
...
//
//        return "DELETE FROM OB_CONSENT_AUTH_RESOURCE WHERE CONSENT_ID = ?";
//    }
//
//    /**
...
//     */
//    public String getDeleteConsentStatusAuditRecordsPreparedStatement() {
//
//        return "DELETE FROM OB_CONSENT_STATUS_AUDIT WHERE CONSENT_ID = ?";
//    }
//
//    /**
...
//     */
//    public String getDeleteConsentPreparedStatement() {
//
//        return "DELETE FROM OB_CONSENT WHERE CONSENT_ID = ?";
//    }
//
//    /**
...
//     */
//    public String getListOfConsentIdsPreparedStatement() {
//
//        return "SELECT CONSENT_ID FROM OB_CONSENT";
//    }
//
